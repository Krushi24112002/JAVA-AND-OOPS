...
public class DifferentLinkedHashSetOperations {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "In LinkedHashSet Duplicate Values Can Not Allowed = " + s1
    );
    ...
    // hashCode() :- This method is used to get the hashCode value for this instance of the LinkedHashSet.
    // It returns an integer value which is the hashCode value for this instance of the LinkedHashSet.
    ...
    // containsAll(collection) :- This method is used to check if the LinkedHashSet contains all the collection of elements.
