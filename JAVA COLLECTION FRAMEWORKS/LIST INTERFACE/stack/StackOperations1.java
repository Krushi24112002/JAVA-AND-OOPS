...
public class StackOperations1 {
  ...
  public static void main(String[] args) {
    ...
    // remove() :- This Method Use To remove Elements At Specific Index in Stack
    l1.remove(1);
    System.out.println(l1);
    ...
    // set() :- Update Stack Using set() method.
    l1.set(1, 24);
    System.out.println(l1);
    ...
    // indexOf() :- This method returns the first occurrence of the given element or -1 if the element is not present in the Stack.
    System.out.println(
    ...
    // clear() :- This method is used to remove all the elements in the Stack. However, the reference of the Stack created is still stored.
    l1.clear();
    System.out.println(l1);
  }
}
