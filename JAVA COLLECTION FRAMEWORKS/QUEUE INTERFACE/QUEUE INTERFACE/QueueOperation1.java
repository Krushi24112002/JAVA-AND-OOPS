...
public class QueueOperation1 {
    ...
    public static void main(String[] args) {
        ...
        // valueOf() :- This Method Use To Remove Perticular Value in Queue Using
        // Specific Value.
        ...
        // with the elements of the Queue.
        ...
        // containsAll() :- This method is used to check if the Queue contains all the
        // collection of elements.
        System.out.println("Are all the contents equal? " + l1.containsAll(l2));

        // clear() :- This method is used to remove all the elements in the Queue.
        // However, the reference of the Queue created is still stored.
        l1.clear();
        System.out.println(l1);
