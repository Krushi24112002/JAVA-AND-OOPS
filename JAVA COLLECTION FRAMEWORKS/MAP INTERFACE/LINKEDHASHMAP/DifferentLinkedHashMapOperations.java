...
public class DifferentLinkedHashMapOperations {
  ...
  public static void main(String[] args) {
    ...
    // put() :- This method is used to associate the specified value with the specified key in this LinkedHashMap.
    s1.put("One", 1);
    s1.put("Three", 3);
    s1.put("Two", 2);
    s1.put("Five", 5);
    ...
    // isEmpty() :- This method is used to check if a LinkedHashMap is having any entry for key and value pairs. If no mapping exists, then this returns true.
    System.out.println("isEmpty() " + s1.isEmpty());

    // size() :- This method is used to return the number of key/value pairs available in the LinkedHashMap.
    ...
    // hashCode() :- This method is used to generate a hashCode for the given LinkedHashMap containing keys and values.
    System.out.println("Key:Value Pair hashCode Is = " + s1.hashCode());

    // remove() :- In order to remove an element from the LinkedHashMap, we can use the remove() method.
    // This method takes the key value and removes the mapping for a key from this map if it is present in the LinkedHashHashMap.
    s1.remove("Two", 2);

    // After Removing One Pair
    System.out.println("After Removing One Pair " + s1);

    // clear() :- This method is used to clear and remove all of the elements or mappings from a specified LinkedHashMap collection.
    s1.clear();
