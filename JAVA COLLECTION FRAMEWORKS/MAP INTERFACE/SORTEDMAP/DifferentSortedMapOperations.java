...
public class DifferentSortedMapOperations {
    ...
    public static void main(String[] args) {
        ...
        // specified key in this SortedMap.
        s1.put("One", 1);
        s1.put("Three", 3);
        s1.put("Two", 2);
        s1.put("Five", 5);
        ...
        // isEmpty() :- This method is used to check if a SortedMap is having any entry
        // for
        ...
        // remove() :- In order to remove an element from the SortedMap, we can use the
        ...
        // mappings from a specified SortedMap collection.
        s1.clear();
