...
public class StackOperations1 {
    ...
    public static void main(String[] args) {
        ...
        // Add Elements Using push() Function in stack
        ...
        // valueOf() :- This Method Use To Remove Perticular Value in List Using
        // Specific Value.
        ...
        // indexOf() :- This method returns the first occurrence of the given element or
        // -1 if the element is not present in the list.
        System.out.println("Return Value Index, if Value Is Present " + l1.indexOf(24));
        System.out.println("if value is not present than return -1 =  " + l1.indexOf(500));

        // equals() :- This method is used to compare the equality of the given element
        ...
        // isEmpty() :- This method is used to check if the list is empty or not. It
        // returns true if the list is empty, else false.
        System.out.println(l1.isEmpty());

        // containsAll() :- This method is used to check if the list contains all the
