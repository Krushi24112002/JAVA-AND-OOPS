...
// Defintion:- Data Abstraction is The Process Of Hiding Certain Details And
 ...
 * class(abstract class) can not be declared as final.
 ...
 * 4. It makes the application secure by not allowing anyone else to see the
 * Background details.
 */
