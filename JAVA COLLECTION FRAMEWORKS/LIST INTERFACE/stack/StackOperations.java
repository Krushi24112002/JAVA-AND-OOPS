...
public class StackOperations {
    ...
    public static void main(String[] args) {
        ...
        // Stack
        // or the element present at the top of the Stack,we can use peek() method. The
        // element retrieved does not get deleted or removed from the Stack.

        System.out.println("First Peek Animal As Per LIFO Rule = " + Animals.peek());
        ...
        System.out.println("After Performoing pop operation in stack peek Animal is Change = " + Animals.peek());

        System.out.println("Print Pop Animal = " + Animals.pop());

        System.out.println("Animals = " + Animals);

        // 4. empty() :- It returns true if nothing is on the top of the stack. Else,
        // returns false.
        System.out.println("empty() Method = " + Animals.empty());

        // 5. search() :- It determines whether an object exists in the stack. If the
        // element is found, It returns the position of the element from the top of the
        // stack. Else, it returns -1.
