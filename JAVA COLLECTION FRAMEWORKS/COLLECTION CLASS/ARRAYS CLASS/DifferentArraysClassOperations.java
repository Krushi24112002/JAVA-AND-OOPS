...
public class DifferentArraysClassOperations {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "Sort Complete Array in Ascending Order = " + Arrays.toString(arr)
    );
    ...
    System.out.println(
      "Sort Array Between Specific Given Rang = " + Arrays.toString(arr1)
    );
    ...
    System.out.println(
      "Copy Array Is = " + Arrays.toString(Arrays.copyOf(arr5, 8))
    );
    ...
    System.out.println(
      "Copy Array Between Specific Range = " +
      Arrays.toString(Arrays.copyOfRange(arr5, 1, 4))
    );
    ...
    System.out.println(
      "Both Array Are Equal Or Not = " + Arrays.equals(arr6, arr7)
    );
    ...
    System.out.println(
      "The element mismatched at index: " + Arrays.mismatch(arr9, arr10)
    );
  }
}
